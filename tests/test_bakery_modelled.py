...
def main():
    ...
    glas_ablage = prefabs.glas_ablage([150, 7, 173.5], traiteur_rot, machine_size, loader, obj_loader)
    bier_ablage = prefabs.bier_ablage([146.5, 7, 173.5], traiteur_rot, machine_size, loader, obj_loader)
    tee_ablage = prefabs.tee_ablage([146.5, 7, 184.5], traiteur_rot, machine_size, loader, obj_loader)
    prosecco_ablage = prefabs.prosecco_ablage([146.5, 7, 184.5], traiteur_rot, machine_size, loader, obj_loader)

    coffee_machine_game_object = prefabs.coffee_machine([150, 12.5, 192], [0, 90, 0], machine_size, loader, obj_loader,
    ...
    entities.extend([coffee_machine_game_object, fridge_game_object, milk_foamer_game_object,
                     ...
                     west_wall_traiteur, ceiling, column, column2])
    nm_entities.extend([])
