...
def cup_heater(pos: list[float], rot: list[float], size: float, loader: Loader, obj_loader: OBJLoader, entities: list, colliders: list) -> GameObject:
    texture = ModelTexture(loader.load_texture("pngs/machinery/heater_tex"))
    texture.set_shine_damper(10)
    texture.set_reflectivity(0.1)

    model = obj_loader.load_obj_model("objs/machinery/heater", loader)
    static_model = TexturedModel(model, texture)
    static_collider = TexturedModel(obj_loader.load_obj_model("objs/machinery/heater_collider", loader),
                                    ModelTexture(loader.load_texture("")))

    ent = Entity(static_model, pos, *rot, size)
    collider = Entity(static_collider, pos, *rot, size)
    heater_game_object = GameObject(ent, collider=collider)

    cup_texture = ModelTexture(loader.load_texture("pngs/cups/big_coffee_cup_tex"))
    cup_texture.set_shine_damper(10)
    cup_texture.set_reflectivity(0.5)

    big_cup_model = obj_loader.load_obj_model("objs/machinery/heater_big_cups", loader)
    static_big_cup_model = TexturedModel(big_cup_model, cup_texture)
    static_big_cup_collider = TexturedModel(obj_loader.load_obj_model("objs/machinery/heater_big_cups_collider", loader),
                                    ModelTexture(loader.load_texture("")))

    big_cup_ent = Entity(static_big_cup_model, pos, *rot, size)
    ...
    static_small_cup_collider = TexturedModel(
        obj_loader.load_obj_model("objs/machinery/heater_small_cups_collider", loader),
        ModelTexture(loader.load_texture("")))

    small_cup_ent = Entity(static_small_cup_model, pos, *rot, size)
...
def plate_spawn(pos: list[float], rot: list[float], size: float, loader: Loader, obj_loader: OBJLoader, entities: list, colliders: list) -> GameObject:
    texture = ModelTexture(loader.load_texture("pngs/food/plate_tex"))
    texture.set_shine_damper(10)
    texture.set_reflectivity(0.5)

    model = obj_loader.load_obj_model("objs/food/plate_spawn", loader)
    static_model = TexturedModel(model, texture)
    static_collider = TexturedModel(obj_loader.load_obj_model("objs/food/plate_spawn_collider", loader),
                                    ModelTexture(loader.load_texture("")))
...
def ice_machine(pos: list[float], rot: list[float], size: float, loader: Loader, obj_loader: OBJLoader,
    ...
    door_pos = [pos[0] - 6, pos[1] + 0.25, pos[2] + 7.85]
...
def glas_ablage(pos: list[float], rot: list[float], size: float, loader: Loader, obj_loader: OBJLoader, entities: list, colliders: list) -> GameObject:
    texture = ModelTexture(loader.load_texture("pngs/shop/glas_ablage_tex"))
    texture.set_shine_damper(10)
    texture.set_reflectivity(0.5)
...
def tee_ablage(pos: list[float], rot: list[float], size: float, loader: Loader, obj_loader: OBJLoader, entities: list, colliders: list) -> GameObject:
    texture = ModelTexture(loader.load_texture("pngs/shop/tee_ablage_tex"))
    texture.set_shine_damper(10)
    texture.set_reflectivity(0.5)
...
def bier_ablage(pos: list[float], rot: list[float], size: float, loader: Loader, obj_loader: OBJLoader, entities: list, colliders: list) -> GameObject:
    texture = ModelTexture(loader.load_texture("pngs/shop/bier_ablage_tex"))
    texture.set_shine_damper(10)
    texture.set_reflectivity(0.5)
...
def prosecco_ablage(pos: list[float], rot: list[float], size: float, loader: Loader, obj_loader: OBJLoader, entities: list, colliders: list) -> GameObject:
    texture = ModelTexture(loader.load_texture("pngs/shop/prosecco_ablage_tex"))
    texture.set_shine_damper(10)
    texture.set_reflectivity(0.5)
...
def small_glass_spawn(pos: list[float], rot: list[float], size: float, loader: Loader, obj_loader: OBJLoader, entities: list, colliders: list) -> GameObject:
    texture = ModelTexture(loader.load_texture("pngs/cups/small_glass_tex"))
    texture.set_shine_damper(10)
    texture.set_reflectivity(0.5)

    model = obj_loader.load_obj_model("objs/cups/small_glass_spawn", loader)
    static_model = TexturedModel(model, texture)
    static_collider = TexturedModel(obj_loader.load_obj_model("objs/cups/small_glass_spawn_collider", loader),
                                    ModelTexture(loader.load_texture("")))
...
def espresso_spawn(pos: list[float], rot: list[float], size: float, loader: Loader, obj_loader: OBJLoader, entities: list, colliders: list) -> GameObject:
    texture = ModelTexture(loader.load_texture("pngs/cups/big_coffee_cup_tex"))
    texture.set_shine_damper(10)
    texture.set_reflectivity(0.5)

    model = obj_loader.load_obj_model("objs/cups/espresso_spawn", loader)
    static_model = TexturedModel(model, texture)
    static_collider = TexturedModel(obj_loader.load_obj_model("objs/cups/espresso_spawn_collider", loader),
                                    ModelTexture(loader.load_texture("")))
...
def english_breakfast(pos: list[float], rot: list[float], size: float, loader: Loader, obj_loader: OBJLoader,
    ...
    bag = ModelTexture(loader.load_texture("pngs/ingredients/english_breakfast_bag"))
...
def earl_grey(pos: list[float], rot: list[float], size: float, loader: Loader, obj_loader: OBJLoader,
    ...
    bag = ModelTexture(loader.load_texture("pngs/ingredients/earl_grey_bag"))
    bag.set_shine_damper(10)
    bag.set_reflectivity(0.5)
...
def ginger(pos: list[float], rot: list[float], size: float, loader: Loader, obj_loader: OBJLoader,
    ...
    bag = ModelTexture(loader.load_texture("pngs/ingredients/ginger_bag"))
    bag.set_shine_damper(10)
    bag.set_reflectivity(0.5)
...
def nana_mint(pos: list[float], rot: list[float], size: float, loader: Loader, obj_loader: OBJLoader,
    ...
    bag = ModelTexture(loader.load_texture("pngs/ingredients/nana_mint_bag"))
    bag.set_shine_damper(10)
    bag.set_reflectivity(0.5)
...
def rooibos(pos: list[float], rot: list[float], size: float, loader: Loader, obj_loader: OBJLoader,
    ...
    bag = ModelTexture(loader.load_texture("pngs/ingredients/rooibos_bag"))
    bag.set_shine_damper(10)
    bag.set_reflectivity(0.5)
...
def verveine(pos: list[float], rot: list[float], size: float, loader: Loader, obj_loader: OBJLoader,
    ...
    bag = ModelTexture(loader.load_texture("pngs/ingredients/verveine_bag"))
    bag.set_shine_damper(10)
    bag.set_reflectivity(0.5)
...
def ticket_machine(pos: list[float], rot: list[float], size: float, loader: Loader, obj_loader: OBJLoader) -> GameObject:
    texture = ModelTexture(loader.load_texture("pngs/machinery/zettel_geraet_tex"))
    texture.set_shine_damper(10)
    texture.set_reflectivity(0.5)

    model = obj_loader.load_obj_model("objs/machinery/zettelgeraet", loader)
    static_model = TexturedModel(model, texture)
    static_collider = TexturedModel(obj_loader.load_obj_model("objs/machinery/zettelgeraet_collider", loader),
                                    ModelTexture(loader.load_texture("")))
